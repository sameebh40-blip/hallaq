...
export function RescheduleClient({ bookingId, barberId, durationMinutes, initialMonth, successHref }: Props) {
  ...
  async function save() {
    ...
    window.location.href = successHref ?? `/bookings/${encodeURIComponent(bookingId)}`;
  }
