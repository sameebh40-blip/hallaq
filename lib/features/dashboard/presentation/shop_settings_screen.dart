      ...
      child: ListView(
        ...
        children: [
          HallaqCard(
            ...
            child: Column(
              children: [
                _Tile(title: 'Shop profile', onTap: () => context.push(Routes.shopManageProfile)),
                const SizedBox(height: 10),
                _Tile(title: 'Shop gallery', onTap: () => context.push(Routes.shopManageGallery)),
                const SizedBox(height: 10),
                _Tile(title: 'Products', onTap: () => context.push(Routes.shopManageProducts)),
                const SizedBox(height: 10),
                _Tile(title: 'Offers', onTap: () => context.push(Routes.shopManageOffers)),
                const SizedBox(height: 10),
